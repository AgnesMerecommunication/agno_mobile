...
import {asyncGetToken, asyncGetUserId, asyncPostPublicKey, asyncPostToken, asyncPostUserId} from '../services/asyncStorage';
import {
...
const ChoosePeridInscription = () => {
  ...
  const handleInscription = async (choose: string) => {
    ...
    formData.append('lastName', inscriptionData.lastName);
